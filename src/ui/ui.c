...
lv_obj_t *ui_vibrationPanel;
lv_obj_t *ui_vibrationIcon;
void ui_event_vibrationSwitch(lv_event_t *e);
lv_obj_t *ui_vibrationSwitch;
lv_obj_t *ui_vibrationLabel;
...
void ui_settingsScreen_screen_init(void)
{
      ...
      ui_vibrationPanel = lv_obj_create(ui_settingsList);
      lv_obj_set_width(ui_vibrationPanel, 200);
      lv_obj_set_height(ui_vibrationPanel, 64);
      lv_obj_set_align(ui_vibrationPanel, LV_ALIGN_CENTER);
      lv_obj_clear_flag(ui_vibrationPanel, LV_OBJ_FLAG_SCROLLABLE); /// Flags
      lv_obj_set_style_radius(ui_vibrationPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_color(ui_vibrationPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_vibrationPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_color(ui_vibrationPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_opa(ui_vibrationPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_width(ui_vibrationPanel, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_side(ui_vibrationPanel, LV_BORDER_SIDE_BOTTOM, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_left(ui_vibrationPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_right(ui_vibrationPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_top(ui_vibrationPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_bottom(ui_vibrationPanel, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

      ui_vibrationIcon = lv_img_create(ui_vibrationPanel);
      lv_img_set_src(ui_vibrationIcon, &ui_img_vibration_png);
      lv_obj_set_width(ui_vibrationIcon, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_vibrationIcon, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_vibrationIcon, -74);
      lv_obj_set_y(ui_vibrationIcon, 2);
      lv_obj_set_align(ui_vibrationIcon, LV_ALIGN_CENTER);
      lv_obj_add_flag(ui_vibrationIcon, LV_OBJ_FLAG_ADV_HITTEST);  /// Flags
      lv_obj_clear_flag(ui_vibrationIcon, LV_OBJ_FLAG_SCROLLABLE); /// Flags
      lv_img_set_zoom(ui_vibrationIcon, 150);

      ui_vibrationSwitch = lv_switch_create(ui_vibrationPanel);
      lv_obj_set_width(ui_vibrationSwitch, 50);
      lv_obj_set_height(ui_vibrationSwitch, 25);
      lv_obj_set_x(ui_vibrationSwitch, 57);
      lv_obj_set_y(ui_vibrationSwitch, 29);

      ui_vibrationLabel = lv_label_create(ui_vibrationPanel);
      lv_obj_set_width(ui_vibrationLabel, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_vibrationLabel, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_vibrationLabel, 54);
      lv_obj_set_y(ui_vibrationLabel, 3);
      lv_label_set_text(ui_vibrationLabel, "Vibration");

      ui_rtwPanel = lv_obj_create(ui_settingsList);
      lv_obj_set_width(ui_rtwPanel, 200);
      lv_obj_set_height(ui_rtwPanel, 64);
      ...
      lv_obj_set_style_bg_opa(ui_rtwPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      ...
      lv_obj_set_style_border_side(ui_rtwPanel, LV_BORDER_SIDE_BOTTOM, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_left(ui_rtwPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_right(ui_rtwPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_top(ui_rtwPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_bottom(ui_rtwPanel, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

      ui_rtwIcon = lv_img_create(ui_rtwPanel);
      lv_img_set_src(ui_rtwIcon, &ui_img_rtw_png);
      lv_obj_set_width(ui_rtwIcon, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_rtwIcon, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_rtwIcon, -74);
      lv_obj_set_y(ui_rtwIcon, 2);
      lv_obj_set_align(ui_rtwIcon, LV_ALIGN_CENTER);
      lv_obj_add_flag(ui_rtwIcon, LV_OBJ_FLAG_ADV_HITTEST);  /// Flags
      lv_obj_clear_flag(ui_rtwIcon, LV_OBJ_FLAG_SCROLLABLE); /// Flags
      lv_img_set_zoom(ui_rtwIcon, 150);

      ui_rtwSwitch = lv_switch_create(ui_rtwPanel);
      lv_obj_set_width(ui_rtwSwitch, 50);
      lv_obj_set_height(ui_rtwSwitch, 25);
      lv_obj_set_x(ui_rtwSwitch, 57);
      lv_obj_set_y(ui_rtwSwitch, 29);

      ui_rtwLabel = lv_label_create(ui_rtwPanel);
      lv_obj_set_width(ui_rtwLabel, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_rtwLabel, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_rtwLabel, 54);
      lv_obj_set_y(ui_rtwLabel, 3);
      lv_label_set_text(ui_rtwLabel, "Raise to wake");
      ...
      ui_accPanel = lv_obj_create(ui_settingsList);
      lv_obj_set_width(ui_accPanel, 200);
      lv_obj_set_height(ui_accPanel, 64);
      lv_obj_set_align(ui_accPanel, LV_ALIGN_CENTER);
      lv_obj_clear_flag(ui_accPanel, LV_OBJ_FLAG_SCROLLABLE); /// Flags
      lv_obj_set_style_radius(ui_accPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_color(ui_accPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_accPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_color(ui_accPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_opa(ui_accPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_width(ui_accPanel, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_side(ui_accPanel, LV_BORDER_SIDE_BOTTOM, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_left(ui_accPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_right(ui_accPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_top(ui_accPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_bottom(ui_accPanel, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

      ui_accIcon = lv_img_create(ui_accPanel);
      lv_img_set_src(ui_accIcon, &ui_img_gyroscope_png);
      lv_obj_set_width(ui_accIcon, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_accIcon, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_accIcon, -74);
      lv_obj_set_y(ui_accIcon, 2);
      lv_obj_set_align(ui_accIcon, LV_ALIGN_CENTER);
      lv_obj_add_flag(ui_accIcon, LV_OBJ_FLAG_ADV_HITTEST);  /// Flags
      lv_obj_clear_flag(ui_accIcon, LV_OBJ_FLAG_SCROLLABLE); /// Flags
      lv_img_set_zoom(ui_accIcon, 150);
      ...
      lv_obj_set_x(ui_accLabel, 53);
      lv_obj_set_y(ui_accLabel, 3);
      lv_label_set_text(ui_accLabel, "Accelerometer");

      ui_accXBar = lv_bar_create(ui_accPanel);
      lv_bar_set_value(ui_accXBar, 25, LV_ANIM_OFF);
      lv_obj_set_width(ui_accXBar, 128);
      lv_obj_set_height(ui_accXBar, 5);
      lv_obj_set_x(ui_accXBar, 21);
      lv_obj_set_y(ui_accXBar, -3);
      lv_obj_set_align(ui_accXBar, LV_ALIGN_CENTER);

      ui_accYBar = lv_bar_create(ui_accPanel);
      lv_bar_set_value(ui_accYBar, 25, LV_ANIM_OFF);
      lv_obj_set_width(ui_accYBar, 128);
      lv_obj_set_height(ui_accYBar, 5);
      lv_obj_set_x(ui_accYBar, 21);
      lv_obj_set_y(ui_accYBar, 8);
      lv_obj_set_align(ui_accYBar, LV_ALIGN_CENTER);

      ui_accZBar = lv_bar_create(ui_accPanel);
      lv_bar_set_value(ui_accZBar, 25, LV_ANIM_OFF);
      lv_obj_set_width(ui_accZBar, 128);
      lv_obj_set_height(ui_accZBar, 5);
      lv_obj_set_x(ui_accZBar, 21);
      lv_obj_set_y(ui_accZBar, 20);
      ...
      ui_powerPanel = lv_obj_create(ui_settingsList);
      lv_obj_set_width(ui_powerPanel, 200);
      lv_obj_set_height(ui_powerPanel, 64);
      ...
      lv_obj_set_style_bg_color(ui_powerPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_bg_opa(ui_powerPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_color(ui_powerPanel, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_opa(ui_powerPanel, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_width(ui_powerPanel, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_border_side(ui_powerPanel, LV_BORDER_SIDE_BOTTOM, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_left(ui_powerPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_right(ui_powerPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_top(ui_powerPanel, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
      lv_obj_set_style_pad_bottom(ui_powerPanel, 5, LV_PART_MAIN | LV_STATE_DEFAULT);

      ui_powerIcon = lv_img_create(ui_powerPanel);
      lv_img_set_src(ui_powerIcon, &ui_img_power_save_png);
      lv_obj_set_width(ui_powerIcon, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_powerIcon, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_powerIcon, -74);
      lv_obj_set_y(ui_powerIcon, 2);
      ...
      lv_img_set_zoom(ui_powerIcon, 150);
      ...
      lv_obj_set_x(ui_powerLabel, 54);
      lv_obj_set_y(ui_powerLabel, 3);
      lv_label_set_text(ui_powerLabel, "Power Saver");

      ui_sleepButton = lv_img_create(ui_powerPanel);
      lv_img_set_src(ui_sleepButton, &ui_img_moon_png);
      lv_obj_set_width(ui_sleepButton, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_sleepButton, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_sleepButton, -25);
      lv_obj_set_y(ui_sleepButton, 10);
      lv_obj_set_align(ui_sleepButton, LV_ALIGN_CENTER);
      lv_obj_add_flag(ui_sleepButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
      lv_obj_clear_flag(ui_sleepButton, LV_OBJ_FLAG_SCROLLABLE);                        /// Flags
      lv_obj_set_style_radius(ui_sleepButton, 5, LV_PART_MAIN | LV_STATE_PRESSED);
      lv_obj_set_style_bg_color(ui_sleepButton, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_PRESSED);
      lv_obj_set_style_bg_opa(ui_sleepButton, 255, LV_PART_MAIN | LV_STATE_PRESSED);

      ui_powerButton = lv_img_create(ui_powerPanel);
      lv_img_set_src(ui_powerButton, &ui_img_switch_png);
      lv_obj_set_width(ui_powerButton, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_powerButton, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_powerButton, 28);
      lv_obj_set_y(ui_powerButton, 10);
      lv_obj_set_align(ui_powerButton, LV_ALIGN_CENTER);
      lv_obj_add_flag(ui_powerButton, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST); /// Flags
      lv_obj_clear_flag(ui_powerButton, LV_OBJ_FLAG_SCROLLABLE);                        /// Flags
      lv_obj_set_style_radius(ui_powerButton, 5, LV_PART_MAIN | LV_STATE_PRESSED);
      lv_obj_set_style_bg_color(ui_powerButton, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_PRESSED);
      ...
      lv_obj_set_width(ui_aboutText, 150);
      ...
      lv_obj_add_event_cb(ui_sleepButton, ui_event_sleepButton, LV_EVENT_ALL, NULL);
      lv_obj_add_event_cb(ui_powerButton, ui_event_powerButton, LV_EVENT_ALL, NULL);
      lv_obj_add_event_cb(ui_vibrationSwitch, ui_event_vibrationSwitch, LV_EVENT_ALL, NULL);
...
void ui_controlScreen_screen_init(void)
{
      ...
      lv_img_set_src(ui_musicPlayButton, &ui_img_play_pause_g_png);
      lv_obj_set_width(ui_musicPlayButton, LV_SIZE_CONTENT);  /// 1
      lv_obj_set_height(ui_musicPlayButton, LV_SIZE_CONTENT); /// 1
      lv_obj_set_x(ui_musicPlayButton, 0);
      lv_obj_set_y(ui_musicPlayButton, 15);
      ...
      lv_img_set_src(ui_musicPrevButton, &ui_img_previous_g_png);
      ...
      lv_obj_set_y(ui_musicPrevButton, 15);
      ...
      lv_img_set_src(ui_musicNextButton, &ui_img_next_g_png);
      ...
      lv_obj_set_y(ui_musicNextButton, 15);
      ...
      lv_obj_set_y(ui_btStateButton, -35);
      ...
      lv_img_set_src(ui_phoneSearchButton, &ui_img_search_g_png);
      ...
      lv_obj_set_y(ui_phoneSearchButton, -35);
      ...
      lv_img_set_src(ui_volumeUpButton, &ui_img_volupe_up_g_png);
      ...
      lv_obj_set_y(ui_volumeUpButton, 65);
      ...
      lv_img_set_src(ui_volumeDownButton, &ui_img_volume_down_g_png);
      ...
      lv_obj_set_y(ui_volumeDownButton, 65);
